...
k8s_resource('backend-kotlin-patterns-v1', port_forwards=8000, resource_deps=['deploy', 'conftest'])
...
docker_build('styled-kotlin-patterns', '.', build_args={'IMAGE_SOURCE': 'node', 'IMAGE_TAG': '12-buster'},
